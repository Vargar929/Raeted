...
public class RateSuccess extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String time=sharedPreferences.getString(getString(R.string.key_time_preference),getString(R.string.default_time_value));
        ...
        //в 1 секунду (задаем значения в миллисекундах):
            new CountDownTimer(timeL, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    timerCounter.setText(getString(R.string.count_label)
                            + millisUntilFinished / 1000 + getString(R.string.sec));
                }
